...
<Tabs items={["Queues", "Channels", "Connections"]}>
  <Tabs.Tab>
    **Queue Analytics**
    - Message count charts by queue
    - Top N queues by message volume
  ...
  <Tabs.Tab>
    **Channel Monitoring**
    ...
    - User-based channel statistics
    - Real-time channel updates
  </Tabs.Tab>
  <Tabs.Tab>
    **Connection Management**
    - Active connection counts
    - User-based connection statistics
    - Connection filtering and search
    - Connection closure tools
  </Tabs.Tab>
</Tabs>
...
<div className="ext-text-center ext-text-sm ext-text-gray-500 ext-mt-8">
  Made with ❤️ by the Hero Rabbit team
</div>
