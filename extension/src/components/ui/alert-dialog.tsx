...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "ext-fixed ext-inset-0 ext-z-50 ext-bg-black/80 data-[state=open]:ext-animate-in data-[state=closed]:ext-animate-out data-[state=closed]:ext-fade-out-0 data-[state=open]:ext-fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      "ext-flex ext-flex-col ext-space-y-2 ext-text-center sm:ext-text-left",
      className
    )}
    {...props}
  />
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "ext-flex ext-flex-col-reverse sm:ext-flex-row sm:ext-justify-end sm:ext-space-x-2",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("ext-text-lg ext-font-semibold", className)}
    {...props}
  />
))
